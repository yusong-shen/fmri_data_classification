...
trainingdirpath = 'C:\Deep Learning\fmri_data_classification\fmri_whole_data\final_result_ver1.1';
...
% 
% save('../data/training_corr_dataset_whole.mat','training_corr_matrix');
% save('../data/training_labels_whole.mat','training_labels');
% % 
...
save('../data/training_halfcorr_dataset_whole.mat','training_corr_matrix');
save('../data/training_halfcorr_labels_whole.mat','training_labels');
