function [trainacc, testacc] = shuffleSoftmaxFMRI2( lambda, range ,datasetnum, nfold)
...
shuffleFMRIDataset( trainingset,traininglabels,testset,testlabels, nfold);
...
[cost, grad] = softmaxCost(theta, numClasses, inputSize, lambda, inputData, s_traininglabels);
...
softmaxModel = softmaxTrain(inputSize, numClasses, lambda, ...
                            inputData, s_traininglabels, options);
...
trainacc = mean(s_traininglabels(:) == pred(:));
...
testacc = mean(s_testlabels(:) == pred(:));
